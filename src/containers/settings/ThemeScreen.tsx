...
const messages = defineMessages({
  ...
  selectedTheme: {
    id: 'settings.app.form.selectedTheme',
  ...
  onSubmit(settingsData) {
    ...
    settings.update({
      ...
      data: {
        ...
        selectedTheme: settingsData.selectedTheme,
  ...
  prepareForm() {
    ...
    const config: FormFields = {
      fields: {
        ...
        selectedTheme: {
          label: intl.formatMessage(messages.selectedTheme),
          value: ifUndefined<string>(
            settings.all.app.selectedTheme,
            DEFAULT_APP_SETTINGS.selectedTheme,
          ),
          default: DEFAULT_APP_SETTINGS.selectedTheme,
        },
        enableSpellchecking: {
